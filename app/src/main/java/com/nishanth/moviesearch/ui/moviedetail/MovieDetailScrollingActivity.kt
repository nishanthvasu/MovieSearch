...
import com.nishanth.moviesearch.databinding.ActivityMovieDetailScrollingBinding
import com.nishanth.moviesearch.ui.home.HomeActivity
import com.nishanth.moviesearch.util.*
            ...
            when (state) {
                ...
                is State.Success -> {
                    ...
                    state.data.let {
                        ...
                        dataBind.textRated.text = "Rated: ${it.rated}"
                        dataBind.textReleased.text = "Release Date: ${it.released}"
                        dataBind.textGenre.text = "Genre: ${it.genre}"
                        dataBind.textPlot.text = it.plot
                        dataBind.textLanguage.text = "Language: ${it.language}"
                    }
                }
                is State.Error -> {
                    dataBind.progressBar.hide()
